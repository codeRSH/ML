...
# read in our data
reviews <- read_csv("C:\\Users\\ravs\\Development\\ML\\IIM\\L7\\deceptive-opinion.csv")
...
#Question - How you will come to know that how many topics you can create
...
top_terms_by_topic_tfidf <- function(text_df, text_column, group_column, plot = T){
  ...
  tf_idf <- words %>%
    #Binf Ter Frequency and Inverse Document frequency
